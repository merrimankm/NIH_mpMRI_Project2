...
class VOIdilation():
    def __init__(self):
        ...
        if local:
            self.mask_folder = r'T:\MIP\Stephanie_Harmon\Projects_MRI\KatieM_outcome\wp_predictions'
            self.dicom_folder = r'T:\MIP\Katie_Merriman\Project2Data\Anonymized_NIfTIs'
            self.csv_file = r'T:\MIP\Katie_Merriman\Project2Data\KM_list.csv'
            self.save_folder = r'T:\MIP\Katie_Merriman\Project2Data\DilatedProstate_data3'
        else:
            self.mask_folder = 'Mdrive_mount/MIP/Stephanie_Harmon/Projects_MRI/KatieM_outcome/wp_predictions'
            self.dicom_folder = 'Mdrive_mount/MIP/Katie_Merriman/Project2Data/Anonymized_NIfTIs'
            self.csv_file = 'Mdrive_mount/MIP/Katie_Merriman/Project2Data/KM_list2.csv'
            self.save_folder = 'Mdrive_mount/MIP/Katie_Merriman/Project2Data/DilatedProstate_data3'
    ...
    def checkVariance(self):
        ...
        for index, file_i in df_csv.iterrows():
            ...
            if not os.path.exists(path):
                os.mkdir(path)
            prostPath = os.path.join(self.mask_folder, wp_id, 'organ', 'organ_mask.nii.gz')
