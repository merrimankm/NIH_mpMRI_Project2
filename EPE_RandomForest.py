...
dfTrain = pd.read_csv(r"T:\MIP\Katie_Merriman\Project2Data\sortedData\SortedPatientData_thresh2_train.csv")
...
dfVal = pd.read_csv(r"T:\MIP\Katie_Merriman\Project2Data\sortedData\SortedPatientData_thresh2_test.csv")
...
trial = 'thresh2 weighted - {1, 10, 8, 5} - TEST'
from sklearn.ensemble import RandomForestClassifier
...
file = open(r"T:\MIP\Katie_Merriman\Project2Data\TEMPclassificationPredictions.csv", 'a+', newline='')
